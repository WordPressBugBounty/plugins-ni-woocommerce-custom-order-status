                           ...
                           <div class="col-xl-3 col-md-6 col-lg-4   box10">
							  <div class="card card-border-top card-border-top-box10  shadow p-3 mb-4 bg-white rounded">
                                  <div class="card-body card-body-padding" >
									...
									<h3 class="m-b-0"><span class="f-right"><?php echo esc_html( wp_strip_all_tags(wc_price( $this->get_total_sales("ALL")))); ?></span></h3>
								</div>
                                  </div>
                                </div>
                            </div>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box4">
							  <div class="card card-border-top card-border-top-box4  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
									...
									<p class="text-right"><span>&nbsp;</span></p>
									<h3 class="m-b-0"><span class="f-right"><?php  echo esc_html( wp_strip_all_tags(  wc_price( $this->get_total_sales("MONTH")))); ?></span></h3>
								</div>
                                  </div>
                                </div>
                            </div>
						   <div class="col-xl-3 col-md-6 col-lg-4   box6">
							  <div class="card card-border-top card-border-top-box6  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
									...
									<p class="text-right"><span>&nbsp;</span></p>
									<h3 class="m-b-0"><span class="f-right"><?php  echo esc_html( wp_strip_all_tags(  wc_price( $this->get_total_sales("WEEK")))); ?></span></h3>
								</div>
                                  </div>
                                </div>
                            </div>
                           <div class="col-xl-3 col-md-6 col-lg-4   box8">
							  <div class="card card-border-top card-border-top-box8  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
									...
									<p class="text-right"><span>&nbsp;</span></p>
									<h3 class="m-b-0"><span class="f-right"><?php  echo esc_html( wp_strip_all_tags(  wc_price( $this->get_total_sales("YESTERDAY")))); ?></span></h3>
								</div>
                                  </div>
                                </div>
                            </div>
                           ...
                           <div class="col-xl-3 col-md-6 col-lg-4   box10">
							  <div class="card card-border-top card-border-top-box10  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
									...
									<p class="text-right"><span>&nbsp;</span></p>
									<h3 class="m-b-0"><span class="f-right"><?php echo esc_html($this->get_total_sales_count("ALL")); ?></span></h3>
								</div>
                                  </div>
                                </div>
                            </div>
						   <div class="col-xl-3 col-md-6 col-lg-4   box1">
							  <div class="card card-border-top card-border-top-box1  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
									...
									<p class="text-right"><span>&nbsp;</span></p>
									<h3 class="m-b-0"><span class="f-right"><?php echo esc_html($this->get_total_sales_count("YEAR")); ?></span></h3>
								</div>
                                  </div>
                                </div>
                            </div>
						   <div class="col-xl-3 col-md-6 col-lg-4   box4">
							  <div class="card card-border-top card-border-top-box4  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
									...
									<p class="text-right"><span>&nbsp;</span></p>
									<h3 class="m-b-0"><span class="f-right"><?php echo esc_html($this->get_total_sales_count("MONTH")); ?></span></h3>
								</div>
                                  </div>
                                </div>
                            </div>
						   <div class="col-xl-3 col-md-6 col-lg-4   box6">
							  <div class="card card-border-top card-border-top-box6  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
									...
									<p class="text-right"><span>&nbsp;</span></p>
									<h3 class="m-b-0"><span class="f-right"><?php echo esc_html($this->get_total_sales_count("WEEK")); ?></span></h3>
								</div>
                                  </div>
                                </div>
                            </div>
                           <div class="col-xl-3 col-md-6 col-lg-4   box8">
							  <div class="card card-border-top card-border-top-box8  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
									...
									<p class="text-right"><span>&nbsp;</span></p>
									<h3 class="m-b-0"><span class="f-right"><?php echo esc_html($this->get_total_sales_count("YESTERDAY")); ?></span></h3>
								</div>
                                  </div>
                                </div>
                            </div>
                           ...
                           <div class="col-xl-3 col-md-6 col-lg-4   box10">
							  <div class="card card-border-top card-border-top-box10  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
									...
									<p class="text-right"><span>&nbsp;</span></p>
									<h3 class="m-b-0"><span class="f-right"><?php echo esc_html( $this->get_customer("ALL")); ?></span></h3>
								</div>
                                  </div>
                                </div>
                            </div>
						   <div class="col-xl-3 col-md-6 col-lg-4   box1">
							  <div class="card card-border-top card-border-top-box1  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
									...
									<p class="text-right"><span>&nbsp;</span></p>
									<h3 class="m-b-0"><span class="f-right"><?php echo esc_html ($this->get_customer("TODAY")); ?></span></h3>
								</div>
                                  </div>
                                </div>
                            </div>
						   <div class="col-xl-3 col-md-6 col-lg-4   box4">
							  <div class="card card-border-top card-border-top-box4  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
									...
									<p class="text-right"><span>&nbsp;</span></p>
									<h3 class="m-b-0"><span class="f-right"><?php echo esc_html($this->get_guest_customer("ALL")); ?></span></h3>
								</div>
                                  </div>
                                </div>
                            </div>
						   <div class="col-xl-3 col-md-6 col-lg-4   box6">
							  <div class="card card-border-top card-border-top-box6  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
									...
									<p class="text-right"><span>&nbsp;</span></p>
									<h3 class="m-b-0"><span class="f-right"><?php echo esc_html($this->get_guest_customer("TODAY")); ?></span></h3>
								</div>
                                  </div>
                                </div>
                            </div>
                           ...
                           <div class="col-xl-3 col-md-6 col-lg-4   box10">
							  <div class="card card-border-top card-border-top-box10  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
									...
									<p class="text-right"><span>&nbsp;</span></p>
									<h3 class="m-b-0"><span class="f-right"><?php echo esc_html($this->get_total_sales_count("DAY")); ?></span></h3>
								</div>
                                  </div>
                                </div>
                            </div>
						   <div class="col-xl-3 col-md-6 col-lg-4   box1">
							  <div class="card card-border-top card-border-top-box1  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
									...
									<p class="text-right"><span>&nbsp;</span></p>
									<h3 class="m-b-0"><span class="f-right"><?php echo esc_html( wp_strip_all_tags(  wc_price( $this->get_total_sales("DAY")))); ?></span></h3>
								</div>
                                  </div>
                                </div>
                            </div>
						   <div class="col-xl-3 col-md-6 col-lg-4   box4">
							  <div class="card card-border-top card-border-top-box4  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
									...
									<p class="text-right"><span>&nbsp;</span></p>
									<h3 class="m-b-0"><span class="f-right"><?php echo esc_html($this->get_sold_product_count("TODAY")); ?></span></h3>
								</div>
                                  </div>
                                </div>
                            </div>
                           <div class="col-xl-3 col-md-6 col-lg-4   box6">
							  <div class="card card-border-top card-border-top-box6  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
									...
									<p class="text-right"><span>&nbsp;</span></p>
									<h3 class="m-b-0"><span class="f-right"><?php echo esc_html( wp_strip_all_tags(  wc_price($this->get_total_discount("TODAY")))); ?></span></h3>
								</div>
                                  </div>
                                </div>
                            </div>
                           <div class="col-xl-3 col-md-6 col-lg-4   box6">
							  <div class="card card-border-top card-border-top-box6  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
									...
									<p class="text-right"><span>&nbsp;</span></p>
									<h3 class="m-b-0"><span class="f-right"><?php echo esc_html( wp_strip_all_tags(   wc_price($this->get_total_tax("TODAY")))); ?></span></h3>
								</div>
                                  </div>
                                </div>
                            </div>
						...
						<div class="col-sm-6 col-md-6 col-lg-6">
                            ...
                            <div class="table-responsive niwoocos-table">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:right"><?php echo esc_html(wp_strip_all_tags( wc_price($value["order_total"]))); ?></td>
                                </tr>
                                <?php }?>
                            </table>
                            </div>
                      ...
                      <div class="card-body "> 
                        <div class="row">
							...
							<tr>
                                ...
                                <td><?php echo esc_html(wp_strip_all_tags( wc_price($v["order_total"]))); ?></td>
                            </tr>
                           <?php } ?> 
						</table>
                            </div>
                        ...
                        <div class="row">
							...
							<tr>
                                ...
                                <td><?php echo esc_html($v->billing_email); ?></td>
                                 <td><?php echo esc_html($v->order_count); ?></td>
                                <td><?php echo esc_html(wp_strip_all_tags($this->get_price($v->order_total))); ?></td>
                            </tr>
                           <?php } ?> 
						</table>
                            </div>
